...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title"> MALLOULI YAHYA 
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            <div className="h3 home__subtitle"> FUTURE ENGINEER </div>
            <p className="home__description"> Hi there, my name is Mallouli Yahya and I'm excited to introduce myself to you! I'm a 21-year-old computer engineering and networks student currently in my fourth year at EMSI (Moroccan School of Engineering Sciences).

Thank you for taking the time to get to know me a bit better. I look forward to connecting with you further! </p>
