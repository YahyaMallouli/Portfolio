...
const Contact = () => {
    ...
    <section className="contact section" id="contact">
        ...
        <div className="contact__container container grid">
            <div className="contatc__content">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data"> ymallouli02@gmail.com </span>
                    ...
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data"> +212658156750 </span>
                    ...
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data"> Mallouli Yahya </span>
            ...
            <div className="contatc__content">
                ...
                <form className="contact__form">
                    ...
                    <div className="contact__form-div contact__form-area">
                        ...
                        <textarea name="commentaire" cols="30" rows="10" className="contact__form-input" placeholder="Write Your Commentaire"></textarea>
                    </div>
